...
if (window.ethereum) {
  ...
  var contractAddress = '0xF4Ae52Deb5ea72A4e8DB77e60D2aD6A3933717f0';
  ...
  function registerSetInfo() {
    info = $("#newInfo").val();
    contract.methods.setProduct (info).send( {from: account}).then( function(tx) { 
  ...
  function registerGetInfo() {
    contract.methods.getProduct().call().then( function( info ) { 
